...
package tutorial_talend_studio.librerias_0_1;
...
/**
 * Job: Librerias Purpose: Librerias<br>
 * Description: Librerias <br>
 * 
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status
 */
public class Librerias implements TalendJob {
	...
	private final String jobName = "Librerias";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Librerias.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void tFileInputRaw_1_error(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public void tConvertType_2_error(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public void tFileInputRaw_1_onSubJobError(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression)
			...
			java.io.InputStream inContext = Librerias.class.getClassLoader()
					.getResourceAsStream("tutorial_talend_studio/librerias_0_1/contexts/" + context + ".properties");
			if (inContext == null) {
				inContext = Librerias.class.getClassLoader()
	...
	public static class camposStruct implements routines.system.IPersistableRow<camposStruct> {
		final static byte[] commonByteArrayLock_TUTORIAL_TALEND_STUDIO_Librerias = new byte[0];
		static byte[] commonByteArray_TUTORIAL_TALEND_STUDIO_Librerias = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TUTORIAL_TALEND_STUDIO_Librerias.length) {
					if (length < 1024 && commonByteArray_TUTORIAL_TALEND_STUDIO_Librerias.length == 0) {
						commonByteArray_TUTORIAL_TALEND_STUDIO_Librerias = new byte[1024];
					} else {
						commonByteArray_TUTORIAL_TALEND_STUDIO_Librerias = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TUTORIAL_TALEND_STUDIO_Librerias, 0, length);
				strReturn = new String(commonByteArray_TUTORIAL_TALEND_STUDIO_Librerias, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_TUTORIAL_TALEND_STUDIO_Librerias, 0, length);
				strReturn = new String(commonByteArray_TUTORIAL_TALEND_STUDIO_Librerias, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TUTORIAL_TALEND_STUDIO_Librerias) {

				try {

					int length = 0;

					this.num_paginas = readInteger(dis);

					this.anio_publicacion = readInteger(dis);

					this.genero = readString(dis);

					this.titulo = readString(dis);

					this.autor = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeInteger(this.num_paginas, dos);

				// Integer

				writeInteger(this.anio_publicacion, dos);
		...
		public String toString() {
			...
			sb.append("[");
			sb.append("num_paginas=" + String.valueOf(num_paginas));
			sb.append(",anio_publicacion=" + String.valueOf(anio_publicacion));
...
// # Outputs initialization
				...
				camposStruct campos_save = null;
//the aggregate variable
				camposStruct campos_aggregate = null;
...
// ###############################
				...
				try {
					String content_tFileInputRaw_1 = org.apache.commons.io.FileUtils.readFileToString(
							new java.io.File(
									"C:/Users/fabio/OneDrive/Escritorio/tutorial-talend-studio/archivos/libro.json"),
							"UTF-8");
				...
				try {
					row2.content = TypeConvert.Object2String(row1.content);
				} catch (java.lang.Exception e) {
...
// Start of branch "row2"
				if (row2 != null) {
					...
					String jsonString = row2.content;

					JSONObject jsonObject = new JSONObject(jsonString);

					String xmlString = XML.toString(jsonObject);

					row3.content = xmlString;
					...
					try {
						row4.content = ParserUtils.parseTo_Document(row3.content);
...
// Start of branch "row4"
					if (row4 != null) {
						...
						docToFlat_tXMLMap_1_TXMLMAP_OUT.setOriginalLoop("/libro");
						docToFlat_tXMLMap_1_TXMLMAP_OUT.setIsOptional(false);
						if (row4.content == null || row4.content.getDocument() == null) {
							throw new RuntimeException("row4.content can't be empty");
						}
						org.dom4j.Document doc_tXMLMap_1_TXMLMAP_OUT = row4.content.getDocument();
						...
						String[] absolutePathMappings_tXMLMap_1_TXMLMAP_OUT = new String[5];
						String[] relativePathMappings_tXMLMap_1_TXMLMAP_OUT = new String[5];

						absolutePathMappings_tXMLMap_1_TXMLMAP_OUT[0] = "row4.content:/libro/anio_publicacion";
						relativePathMappings_tXMLMap_1_TXMLMAP_OUT[0] = "anio_publicacion";

						absolutePathMappings_tXMLMap_1_TXMLMAP_OUT[1] = "row4.content:/libro/num_paginas";
						relativePathMappings_tXMLMap_1_TXMLMAP_OUT[1] = "num_paginas";

						absolutePathMappings_tXMLMap_1_TXMLMAP_OUT[2] = "row4.content:/libro/autor";
						relativePathMappings_tXMLMap_1_TXMLMAP_OUT[2] = "autor";

						absolutePathMappings_tXMLMap_1_TXMLMAP_OUT[3] = "row4.content:/libro/genero";
						relativePathMappings_tXMLMap_1_TXMLMAP_OUT[3] = "genero";

						absolutePathMappings_tXMLMap_1_TXMLMAP_OUT[4] = "row4.content:/libro/titulo";
						relativePathMappings_tXMLMap_1_TXMLMAP_OUT[4] = "titulo";
...
// # Output table : 'campos'
								...
								campos_tmp = new camposStruct();
								campos_tmp.num_paginas = treeNodeAPI_tXMLMap_1_TXMLMAP_OUT
										.get_Integer("row4.content:/libro/num_paginas");
								campos_tmp.anio_publicacion = treeNodeAPI_tXMLMap_1_TXMLMAP_OUT
										.get_Integer("row4.content:/libro/anio_publicacion");
								campos_tmp.genero = treeNodeAPI_tXMLMap_1_TXMLMAP_OUT
										.get_String("row4.content:/libro/genero");
								campos_tmp.titulo = treeNodeAPI_tXMLMap_1_TXMLMAP_OUT
										.get_String("row4.content:/libro/titulo");
								campos_tmp.autor = treeNodeAPI_tXMLMap_1_TXMLMAP_OUT
										.get_String("row4.content:/libro/autor");
								allOutsForAggregate_tXMLMap_1.add(campos_tmp);
...
// ###############################
				...
				class Util_tLogRow_1 {
					...
					public String print(String[] row, int nbLine) {
						...
						// for(int i=0; i<row.length; i++){
						sb.append("| " + "num_paginas");
						for (int i = 0; i < titleWidth - "num_paginas".length() + 1; i++)
							sb.append(" ");
						sb.append("| " + row[0]);
						...
						// for(int i=0; i<row.length; i++){
						sb.append("| " + "anio_publicacion");
						for (int i = 0; i < titleWidth - "anio_publicacion".length() + 1; i++)
							sb.append(" ");
						sb.append("| " + row[1]);
						...
						// for(int i=0; i<row.length; i++){
						sb.append("| " + "genero");
						for (int i = 0; i < titleWidth - "genero".length() + 1; i++)
							sb.append(" ");
						sb.append("| " + row[2]);
						...
						// for(int i=0; i<row.length; i++){
						sb.append("| " + "titulo");
						for (int i = 0; i < titleWidth - "titulo".length() + 1; i++)
							sb.append(" ");
						sb.append("| " + row[3]);
						...
						// for(int i=0; i<row.length; i++){
						sb.append("| " + "autor");
						for (int i = 0; i < titleWidth - "autor".length() + 1; i++)
							sb.append(" ");
						sb.append("| " + row[4]);
...
///////////////////////    			
				...
				for (Object row_out_tXMLMap_1_TXMLMAP_IN : outs_tXMLMap_1) {// TD512
					...
					campos = null;
					if (row_out_tXMLMap_1_TXMLMAP_IN != null && row_out_tXMLMap_1_TXMLMAP_IN instanceof camposStruct) {
						campos = (camposStruct) row_out_tXMLMap_1_TXMLMAP_IN;
					}
...
///////////////////////		
						...
						if (campos.num_paginas != null) { //

							strBuffer_tLogRow_1.append(String.valueOf(campos.num_paginas));

						} //

						strBuffer_tLogRow_1.append("|");

						if (campos.anio_publicacion != null) { //

							strBuffer_tLogRow_1.append(String.valueOf(campos.anio_publicacion));

						} //

						strBuffer_tLogRow_1.append("|");

						if (campos.genero != null) { //

							strBuffer_tLogRow_1.append(String.valueOf(campos.genero));
						...
						if (campos.titulo != null) { //
							...
							strBuffer_tLogRow_1.append(String.valueOf(campos.titulo));

						} //

						strBuffer_tLogRow_1.append("|");

						if (campos.autor != null) { //

							strBuffer_tLogRow_1.append(String.valueOf(campos.autor));
						...
						if (campos.num_paginas != null) { //
							row_tLogRow_1[0] = String.valueOf(campos.num_paginas);

						} //

						if (campos.anio_publicacion != null) { //
							row_tLogRow_1[1] = String.valueOf(campos.anio_publicacion);

						} //

						if (campos.genero != null) { //
							row_tLogRow_1[2] = String.valueOf(campos.genero);

						} //

						if (campos.titulo != null) { //
							row_tLogRow_1[3] = String.valueOf(campos.titulo);

						} //

						if (campos.autor != null) { //
							row_tLogRow_1[4] = String.valueOf(campos.autor);
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final Librerias LibreriasClass = new Librerias();

		int exitCode = LibreriasClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Librerias.class.getClassLoader()
					.getResourceAsStream("tutorial_talend_studio/librerias_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Librerias.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Librerias");
		}
...
/************************************************************************************************
 * 86217 characters generated by Talend Open Studio for ESB on the 24 de mayo de
 * 2024, 15:26:05 ART
 ************************************************************************************************/