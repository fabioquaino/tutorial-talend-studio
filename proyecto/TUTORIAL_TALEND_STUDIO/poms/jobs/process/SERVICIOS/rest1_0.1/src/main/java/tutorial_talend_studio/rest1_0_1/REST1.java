...
package tutorial_talend_studio.rest1_0_1;
...
/**
 * Job: REST1 Purpose: REST1<br>
 * Description: REST1 <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class REST1 implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "REST1";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(REST1.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class RestServiceProviderImpl4TalendJob {
	...
	private final REST1 job;

	public RestServiceProviderImpl4TalendJob(REST1 job) {
		this.job = job;
	}

	private void populateRequestWithJobContext(java.util.Map<String, Object> requestGlobalMap, REST1 job) {
	...
	@javax.ws.rs.Path("/persona/{nombre}")	@javax.ws.rs.Consumes({ "application/json" })	@javax.ws.rs.Produces({ "application/json" })
	public javax.ws.rs.core.Response entrada(
		
				@javax.ws.rs.QueryParam("edad") Integer edad
		, 
		...
		request_tRESTRequest_1.put("OPERATION", "entrada");
		request_tRESTRequest_1.put("PATTERN", "/persona/{nombre}");
		...
		java.util.Map<String, Object> parameters_tRESTRequest_1 = new java.util.HashMap<String, Object>();
			...
			parameters_tRESTRequest_1.put("QUERY:edad:id_Integer", edad);
		
			parameters_tRESTRequest_1.put("PATH:nombre:id_String", nombre);
...
class Thread4RestServiceProviderEndpoint extends Thread {
	...
	public Thread4RestServiceProviderEndpoint(REST1 job, String endpointUrl) {
		this.job = job;
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression)
			...
			java.io.InputStream inContext = REST1.class.getClassLoader()
					.getResourceAsStream("tutorial_talend_studio/rest1_0_1/contexts/" + context + ".properties");
			if (inContext == null) {
				inContext = REST1.class.getClassLoader()
...
public static class errorauthStruct implements routines.system.IPersistableRow<errorauthStruct> {
    final static byte[] commonByteArrayLock_TUTORIAL_TALEND_STUDIO_REST1 = new byte[0];
    static byte[] commonByteArray_TUTORIAL_TALEND_STUDIO_REST1 = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_TUTORIAL_TALEND_STUDIO_REST1.length) {
				if(length < 1024 && commonByteArray_TUTORIAL_TALEND_STUDIO_REST1.length == 0) {
   					commonByteArray_TUTORIAL_TALEND_STUDIO_REST1 = new byte[1024];
				} else {
   					commonByteArray_TUTORIAL_TALEND_STUDIO_REST1 = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_TUTORIAL_TALEND_STUDIO_REST1, 0, length);
			strReturn = new String(commonByteArray_TUTORIAL_TALEND_STUDIO_REST1, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_TUTORIAL_TALEND_STUDIO_REST1, 0, length);
			strReturn = new String(commonByteArray_TUTORIAL_TALEND_STUDIO_REST1, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_TUTORIAL_TALEND_STUDIO_REST1) {
     ...
     * Compare keys
     */
    public int compareTo(errorauthStruct other) {
...
public static class camposStruct implements routines.system.IPersistableRow<camposStruct> {
    final static byte[] commonByteArrayLock_TUTORIAL_TALEND_STUDIO_REST1 = new byte[0];
    static byte[] commonByteArray_TUTORIAL_TALEND_STUDIO_REST1 = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(camposStruct other) {
...
public static class setStruct implements routines.system.IPersistableRow<setStruct> {
    final static byte[] commonByteArrayLock_TUTORIAL_TALEND_STUDIO_REST1 = new byte[0];
    static byte[] commonByteArray_TUTORIAL_TALEND_STUDIO_REST1 = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(setStruct other) {
...
public static class authStruct implements routines.system.IPersistableRow<authStruct> {
    final static byte[] commonByteArrayLock_TUTORIAL_TALEND_STUDIO_REST1 = new byte[0];
    static byte[] commonByteArray_TUTORIAL_TALEND_STUDIO_REST1 = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(authStruct other) {
...
public static class noauthStruct implements routines.system.IPersistableRow<noauthStruct> {
    final static byte[] commonByteArrayLock_TUTORIAL_TALEND_STUDIO_REST1 = new byte[0];
    static byte[] commonByteArray_TUTORIAL_TALEND_STUDIO_REST1 = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(noauthStruct other) {
...
authStruct auth = new authStruct();
setStruct set = new setStruct();
jsonStruct json = new jsonStruct();
row1Struct row1 = new row1Struct();
camposStruct campos = new camposStruct();
outStruct out = new outStruct();
salidaStruct salida = new salidaStruct();
noauthStruct noauth = new noauthStruct();
row3Struct row3 = new row3Struct();
errorauthStruct errorauth = new errorauthStruct();
	...
	currentComponent="tRESTRequest_1_Loop";
		...
		int tos_count_tRESTRequest_1_Loop = 0;
						...
						if(execStat){
							runStat.updateStatOnConnection(iterateId,0,0,"entrada","row2","auth","set","json","row1","campos","out","salida","noauth","row3","errorauth");
						}
 ...
 */
	...
	currentComponent="tSetGlobalVar_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"set");
					}
 ...
 */
	...
	currentComponent="tXMLMap_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"campos");
					}
...
//    	this.treeNodeAPI = treeNodeAPI;
    ...
    void generateElements(boolean isInnerJoin, camposStruct campos, Var__tXMLMap_1__Struct Var
	) {
...
if (needRoot) {
	needRoot=false;
		...
		org.dom4j.Element root_0 = null;
				root_0 = root.addElement("apellido");
		valueMap.put("root_0",campos.apellido);
		...
		org.dom4j.Element root_1 = null;
				root_1 = root.addElement("estudios");
		valueMap.put("root_1",campos.estudios);
		...
		org.dom4j.Element root_2 = null;
				root_2 = root.addElement("nombre");
		valueMap.put("root_2",campos.nombre);
		...
		org.dom4j.Element root_3 = null;
				root_3 = root.addElement("edad");
		valueMap.put("root_3",campos.edad);
...
// ###############################
// # Outputs initialization
camposStruct campos_tmp = new camposStruct();
// ###############################
 ...
 */
	...
	currentComponent="tMap_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"auth");
					}
...
// ###############################
// # Outputs initialization
setStruct set_tmp = new setStruct();
 ...
 */
	...
	currentComponent="tRESTResponse_2";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"errorauth");
					}
...
// ###############################
// # Outputs initialization
errorauthStruct errorauth_tmp = new errorauthStruct();
// ###############################
 ...
 */
	...
	currentComponent="tJavaRow_2";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"noauth");
					}
...
// ###############################
// # Outputs initialization
authStruct auth_tmp = new authStruct();
noauthStruct noauth_tmp = new noauthStruct();
// ###############################
 ...
 */
	...
	currentComponent="tJavaRow_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"entrada");
					}
		...
		if (requestMessage_tRESTRequest_1.containsKey("ERROR")) { // wrong request received
			...
			java.util.Map<String, Object> params_tRESTRequest_1 =
				(java.util.Map<String, Object>) requestMessage_tRESTRequest_1.get("PARAMS");
					if (matchedFlow_tRESTRequest_1.equals("entrada")) {
						entrada = new entradaStruct();
								if (params_tRESTRequest_1.containsKey("PATH:nombre:id_String")) {
									
										
										entrada.nombre = (String) params_tRESTRequest_1.get("PATH:nombre:id_String");
									
								}
								if (params_tRESTRequest_1.containsKey("QUERY:edad:id_Integer")) {
									
										
										entrada.edad = (Integer) params_tRESTRequest_1.get("QUERY:edad:id_Integer");
								...
								if (null != bodyObject_tRESTRequest_1) {
										...
										entrada.body = (String) bodyObject_tRESTRequest_1;
...
if(entrada != null) { 
    ...
    row2.nombre = entrada.nombre;
row2.edad = entrada.edad;
row2.body = entrada.body;
...
row2.username = values[0];
row2.password = values[1];
    nb_line_tJavaRow_1++;   
...
Var.auth = (row2.username.equals("ejemplo") && row2.password.equals("12345")) ? true : false ;// ###############################
        // ###############################
        // # Output tables
...
auth_tmp.nombre = row2.nombre ;
auth_tmp.edad = row2.edad ;
auth_tmp.body = row2.body ;
auth = auth_tmp;
...
noauth_tmp.msg = "ERROR AL AUTENTICAR";
noauth = noauth_tmp;
} // closing filter/reject
// ###############################
...
// # Output table : 'set'
set_tmp.nombre = auth.nombre;
set_tmp.edad = auth.edad;
set = set_tmp;

// # Output table : 'json'
json_tmp.body = auth.body;
json = json_tmp;
// ###############################
...
globalMap.put("NOMBRE", set.nombre);
globalMap.put("EDAD", set.edad);
...
if(json != null) { 
	...
	currentComponent="tExtractJSONFields_1";
            ...
            if(json.body!=null){// C_01
                jsonStr_tExtractJSONFields_1 = json.body.toString();
...
for(int i_tExtractJSONFields_1=0; isStructError_tExtractJSONFields_1 || (i_tExtractJSONFields_1 < resultset_tExtractJSONFields_1.size());i_tExtractJSONFields_1++){
	...
	try {
		jsonPath_tExtractJSONFields_1 = "apellido";
		...
		try {
				...
				row1.apellido = value_tExtractJSONFields_1 == null ? 
...
;
		...
		jsonPath_tExtractJSONFields_1 = "estudios";
		compiledJsonPath_tExtractJSONFields_1 = jsonPathCache_tExtractJSONFields_1.getCompiledJsonPath(jsonPath_tExtractJSONFields_1);
		...
		try {
				...
				row1.estudios = value_tExtractJSONFields_1 == null ? 
...
// # Output table : 'campos'
campos_tmp.apellido = row1.apellido ;
campos_tmp.estudios = row1.estudios ;
campos_tmp.nombre = ((String)globalMap.get("NOMBRE"));
campos_tmp.edad = ((Integer)globalMap.get("EDAD"));
campos = campos_tmp;
// ###############################
...
gen_Doc_out_tXMLMap_1.generateElements(rejectedDocInnerJoin_tXMLMap_1,campos,Var);
...
if(salida != null) { 
	...
	if (null == outputStream_tRESTResponse_1 && responseAlreadySent_tRESTResponse_1) {
		...
		if (null != salida.body) {
			restProviderResponse_tRESTResponse_1 = salida.body.getDocument();
		}
...
// # Output table : 'errorauth'
errorauth_tmp.body = row3.msg ;
errorauth = errorauth_tmp;
// ###############################
...
if(errorauth != null) { 
	...
	if (null == outputStream_tRESTResponse_2 && responseAlreadySent_tRESTResponse_2) {
		...
		restProviderResponse_tRESTResponse_2 = errorauth.body;
...
globalMap.put("tJavaRow_1_NB_LINE",nb_line_tJavaRow_1);
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"entrada");
			  	}
...
// ###############################      
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"auth");
			  	}
 ...
 */
	...
	currentComponent="tSetGlobalVar_1";
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"set");
			  	}
 ...
 */
	...
	currentComponent="tXMLMap_1";
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"campos");
			  	}
...
globalMap.put("tJavaRow_2_NB_LINE",nb_line_tJavaRow_2);
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"noauth");
			  	}
 ...
 */
	...
	currentComponent="tRESTResponse_2";
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"errorauth");
			  	}
 ...
 */
	...
	globalMap.put("tRESTRequest_1_NB_LINE", nb_line_tRESTRequest_1);
				...
				if(execStat){
					runStat.updateStatOnConnection(iterateId,2,0,"entrada","row2","auth","set","json","row1","campos","out","salida","noauth","row3","errorauth");
				}
 ...
 */
    ...
    public static void main(String[] args){
        final REST1 REST1Class = new REST1();

        int exitCode = REST1Class.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = REST1.class.getClassLoader().getResourceAsStream("tutorial_talend_studio/rest1_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = REST1.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : REST1");
        }
...
/************************************************************************************************
 *     177769 characters generated by Talend Open Studio for ESB 
 *     on the 29 de mayo de 2024, 15:52:22 ART
 ************************************************************************************************/