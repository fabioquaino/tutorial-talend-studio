...
package tutorial_talend_studio.basededatos_0_1;
...
/**
 * Job: BaseDeDatos Purpose: BaseDeDatos<br>
 * Description: BaseDeDatos <br>
 * 
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status
 */
public class BaseDeDatos implements TalendJob {
	...
	private final String jobName = "BaseDeDatos";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(BaseDeDatos.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression)
			...
			java.io.InputStream inContext = BaseDeDatos.class.getClassLoader()
					.getResourceAsStream("tutorial_talend_studio/basededatos_0_1/contexts/" + context + ".properties");
			if (inContext == null) {
				inContext = BaseDeDatos.class.getClassLoader()
	...
	public static class row6Struct implements routines.system.IPersistableRow<row6Struct> {
		final static byte[] commonByteArrayLock_TUTORIAL_TALEND_STUDIO_BaseDeDatos = new byte[0];
		static byte[] commonByteArray_TUTORIAL_TALEND_STUDIO_BaseDeDatos = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TUTORIAL_TALEND_STUDIO_BaseDeDatos.length) {
					if (length < 1024 && commonByteArray_TUTORIAL_TALEND_STUDIO_BaseDeDatos.length == 0) {
						commonByteArray_TUTORIAL_TALEND_STUDIO_BaseDeDatos = new byte[1024];
					} else {
						commonByteArray_TUTORIAL_TALEND_STUDIO_BaseDeDatos = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TUTORIAL_TALEND_STUDIO_BaseDeDatos, 0, length);
				strReturn = new String(commonByteArray_TUTORIAL_TALEND_STUDIO_BaseDeDatos, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_TUTORIAL_TALEND_STUDIO_BaseDeDatos, 0, length);
				strReturn = new String(commonByteArray_TUTORIAL_TALEND_STUDIO_BaseDeDatos, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TUTORIAL_TALEND_STUDIO_BaseDeDatos) {

				try {

					int length = 0;

					this.materia = readString(dis);

					length = dis.readByte();
					if (length == -1) {
						this.promedio = null;
					} else {
						this.promedio = dis.readFloat();
					}
	...
	public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
		...
		public String dni_param;

		public String getDni_param() {
			return this.dni_param;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TUTORIAL_TALEND_STUDIO_BaseDeDatos) {
				...
				try {
					...
					this.dni_param = readString(dis);

					this.resultado = (Object) dis.readObject();
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.dni_param, dos);

				// Object

				dos.writeObject(this.resultado);
...
///////////////////////    			
				...
				String properties_tDBSP_1 = "noDatetimeStringSync=true&useSSL=false";
				if (properties_tDBSP_1 == null || properties_tDBSP_1.trim().length() == 0) {
					properties_tDBSP_1 = "";
				}
				String url_tDBSP_1 = "jdbc:mysql://" + "localhost" + ":" + "6000" + "/" + "talend_escuela" + "?"
						+ properties_tDBSP_1;

				String dbUser_tDBSP_1 = "root";

				final String decryptedPassword_tDBSP_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:R0Z4hRqLc/w+0qd/8qSXkP1SMFWF1U1aao0jIMD8SBQ=");

				String dbPwd_tDBSP_1 = decryptedPassword_tDBSP_1;

				java.lang.Class.forName("com.mysql.jdbc.Driver");
				connection_tDBSP_1 = java.sql.DriverManager.getConnection(url_tDBSP_1, dbUser_tDBSP_1, dbPwd_tDBSP_1);

				java.sql.CallableStatement statement_tDBSP_1 = connection_tDBSP_1
						.prepareCall("{call " + "ObtenerPromedioPorMateria" + "(?)}");
				...
				for (int i_tFixedFlowInput_1 = 0; i_tFixedFlowInput_1 < 1; i_tFixedFlowInput_1++) {
					...
					if (row5.dni_param == null) {
						statement_tDBSP_1.setNull(1, java.sql.Types.VARCHAR);
					} else {

						statement_tDBSP_1.setString(1, row5.dni_param);

					}

					statement_tDBSP_1.execute();

					row4.dni_param = row5.dni_param;

					row4.resultado = statement_tDBSP_1.getResultSet();
					...
					java.sql.ResultSet re_tParseRecordSet_1 = (java.sql.ResultSet) row4.resultado;
					...
					while (true) {
						...
						res_str_tParseRecordSet_1 = re_tParseRecordSet_1.getString("materia");
						if (res_str_tParseRecordSet_1 != null) {
							row6.materia = res_str_tParseRecordSet_1.trim();
						} else {
							// row6.materia = res_str_tParseRecordSet_1;
							row6.materia = null;
						}
						res_str_tParseRecordSet_1 = re_tParseRecordSet_1.getString("promedio");
						if (res_str_tParseRecordSet_1 != null) {
							row6.promedio = ParserUtils.parseTo_Float(res_str_tParseRecordSet_1.trim());
						} else {
							// row6.promedio = ParserUtils.parseTo_Float(res_str_tParseRecordSet_1);
							row6.promedio = null;
						}
...
///////////////////////		
						...
						if (row6.materia != null) { //

							strBuffer_tLogRow_2.append(String.valueOf(row6.materia));

						} //

						strBuffer_tLogRow_2.append("|");

						if (row6.promedio != null) { //

							strBuffer_tLogRow_2.append(FormatterUtils.formatUnwithE(row6.promedio));
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final BaseDeDatos BaseDeDatosClass = new BaseDeDatos();

		int exitCode = BaseDeDatosClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = BaseDeDatos.class.getClassLoader().getResourceAsStream(
					"tutorial_talend_studio/basededatos_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = BaseDeDatos.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : BaseDeDatos");
		}
...
/************************************************************************************************
 * 57362 characters generated by Talend Open Studio for ESB on the 23 de mayo de
 * 2024, 15:17:29 ART
 ************************************************************************************************/